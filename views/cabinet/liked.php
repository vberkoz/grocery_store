    ...
    <aside class="col-md-9">
        <div class="row">
            <?php foreach ($products as $key => $product): ?>
                <div class="col-6 col-md-3 pl-1 pr-1 pb-2 product-card">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between p-3">
                            <?php if ($product['availability']): ?>
                                <a href="#" style="padding: 7px 0 6px 0;"
                                   class="add-to-bag-first btn btn-outline-primary btn-sm invisible"
                                ...
                                <div class="input-group d-none">
                                    <div class="input-group-prepend">
                                        <button class="btn btn-outline-primary remove-from-bag" type="button"
                                                data-id="<?php echo $product['id']; ?>"
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-primary add-to-bag-second" type="button"
                                                data-id="<?php echo $product['id']; ?>"
                                                data-volume_min="<?php echo $product['volume_min']; ?>"
                                                data-unit="<?php echo $product['unit']; ?>"
                                        >
