<?php include_once ROOT . '/views/layouts/admin_header.php'?>
    ...
    <div class="card mb-3 w-100">
        <div class="card-body">
            <a href="/admin/category/create" class="btn btn-primary mb-3">Додати категорію</a>
            <?php if ($categories): ?>
                <div class="row px-3">
                    <table class="table table-responsive-sm">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-center">Показувати</th>
                            <th scope="col"></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($categories as $key => $category): ?>
                            <tr class="product-record">
                                <td class="align-middle">
                                    <a class="btn btn-outline-secondary btn-sm border-0" href="/admin/category/update/<?php echo $category['id']; ?>">
                                ...
                                <td class="align-middle"><?php echo $category['title']; ?></td>
                                ...
                                <td class="align-middle text-center">
                                    <a class="btn btn-outline-danger btn-sm border-0" href="/admin/category/delete/<?php echo $category['id']; ?>">
            ...
            <?php else: ?>
                <p>Тут ще немає жодної категорії</p>
            <?php endif; ?>
        </div>
    </div>
