    ...
    <div class="col-12">
        <?php if ($yesterdayProducts): ?>
            <div class="card mb-3 mx-auto">
                <div class="card-body">
                    <h5 class="card-title">
                        Всього товарів з 04:00 <?php echo (date('j')-1) . date('-n') . date('-Y') ?>
                        до 04:00 <?php echo date('j') . date('-n') . date('-Y') ?>
                    </h5>
                    <div class="row px-3">
                            ...
                            <?php foreach ($yesterdayProducts as $key => $product): ?>
                                <tr class="product-record">
                                    ...
                                    <td class="align-middle text-left">
                                        ...
                                        if ($product['unit'] == 'г') { echo 'шт'; } else { echo 'кг'; }?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
            ...
            <?php foreach ($yesterdayOrders as $order): ?>
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        <h5 class="card-title">
        ...
        <?php else: ?>
            <div class="alert alert-secondary" role="alert">
                Замовлень з 04:00 <?php echo (date('j')-1) . date('-n') . date('-Y') ?>
                до 04:00 <?php echo date('j') . date('-n') . date('-Y') ?>
                немає
            </div>
        <?php endif; ?>
