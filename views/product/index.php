        ...
        <div class="col-6 col-md-2 pl-1 pr-1 pb-2">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column justify-content-between p-3">
                    <a href="#" class="add-to-bag-first btn btn-outline-primary btn-sm" data-id="<?php echo $product['id']; ?>" style="padding: 6px;">
                    ...
                    <p class="card-text pt-2" style="min-height: 48px;max-height: 48px;"><?php echo $product['title']; ?></p>
