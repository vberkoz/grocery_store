...
<aside class='container-fluid'>
    <div class='row' id='products'>
        <div class='col-md-12 col-xl-8 offset-xl-2 p-1'>
            <nav class='card' aria-label='breadcrumb'>
                <ol class='breadcrumb m-0' style='background-color: rgba(255, 255, 128, .0)'>
                    <li class='breadcrumb-item'><a href='$dir/index.html'>$breadcrumbCap</a></li>
        ...
        <div class='col-md-6 col-xl-4 p-1'>
            <div class='card'>
                <div class='card-body'>
                    <p class='text-muted'><small><strong>$codeCap: $code</strong></small></p>
                    <h1 class='card-title'><strong>$title</strong></h1>
                    <p class='text-muted'>
                        <small>$priceForCap $vol $unit</small><br>
                        <small>$minOrderCap $vol_min $unit</small>
                    </p>
            ...
            <div class='card mt-2'>
                <div class='card-body'>
                    <h4 class='card-title'>$charCap</h4><hr>$char
                </div>
            </div>
        </div>
        ...
        <div class='col-md-6 col-xl-4 offset-xl-2 p-1'>
            <div class='card'>
                <div class='card-body'>
                    <h4 class='card-title'>$usefulCap</h4><hr>$desc
                </div>
            </div>
        </div>
            ...
            <div class='card'>
                <div class='card-body'>
                    <div class='d-flex justify-content-between'>
                        <h4 class='card-title mb-0'>$reviewsCap</h4>
                        <button type='button' class='btn btn-sm btn-link' data-toggle='modal' data-target='#productReview'>$writeCap</button>
                        <div class='modal fade' id='productReview' tabindex='-1' role='dialog' aria-hidden='true'>
                            <div class='modal-dialog' role='document'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        <h5 class='modal-title'>$yourReviewCap</h5>
                                    ...
                                    <div class='modal-body'>
                                        <form>
                                            ...
                                            <div class='form-group'>
                                                <label for='reviewer_name'>$reviewerNameCap</label>
                                                <input type='text' class='form-control' id='reviewer_name'
                                                       placeholder='$reviewerNameCap'>
                                            </div>
                                            <div class='form-group'>
                                                <label for='reviewer_email'>$reviewerEmailCap</label>
                                                <input type='email' class='form-control' id='reviewer_email'
                                                       placeholder='name@example.com'>
                                            </div>
                                            <div class='form-group'>
                                                <label for='reviewer_text'>$reviewerMsgCap</label>
                                                <textarea class='form-control' id='reviewer_text' rows='3'
                                                          placeholder='$reviewerMsgCap'></textarea>
                                            </div>
                                        </form>
                                    </div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-secondary' data-dismiss='modal'>$cancelCap
                                        </button>
                                        <button type='button' class='btn btn-primary' data-dismiss='modal'
                                                onclick='saveReview()'>$saveCap
                                        </button>
                                    </div>
                                </div>
                            </div>
