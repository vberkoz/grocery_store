...
<!--        Сьогодні ми доставляємо замовлення які були здійснені вчора і сьогодні до 4-ї години ранку.-->
<!--        Решта замовлень будуть оброблені завтра.-->
<!--    </div>-->
<!--</div>-->

<!--<aside class="col-xl-2 col-md-3 px-1 pb-2 pt-0">-->
<!--    <div class="card mb-2">-->
<!--        <div class="card-body">-->
<!--            <form class="form-inline">-->
<!--                <input class="form-control w-100 product-index-search"-->
<!--                       type="search" placeholder="Пошук" data-user-id="--><?php //echo $userId; ?><!--">-->
<!--            </form>-->
<!--        </div>-->
<!--    </div>-->
...
<!--            <a href="/category/--><?php //echo $category['id']; ?><!--" class="list-group-item list-group-item-action-->
...
<aside class="col-12">
    ...
    <?php foreach ($products as $key => $product): ?>
        <div class="col-xl-2 col-md-3 col-6 pl-1 pr-1 pb-2 product-card" data-id="<?php echo $product['id']; ?>">
